                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            ...
                            <input v-model="themmoi.ten_hang_xe" type="text" class="form-control">
                        </div>
                        <div class="mb-2">
                            <label>Hình Ảnh</label>
                            <input v-model="themmoi.logo" type="text" class="form-control">
                        </div>
                        <div class="mb-2">
                            <label>Mô Tả</label>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center align-middle">Tên Hãng Xe</th>
                                ...
                                <tbody>
                                    <template v-for="(v, k) in list_data">
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">@{{v.ten_hang_xe}}</td>
                                            <td class="text-center align-middle">
                                                <img v-bind:src="v.logo" height="100px" width="100px" class="rounded-circle mx-auto d-block" alt="...">
                                            </td>
                                            <td class="text-center align-middle">
                                                <textarea disabled cols="20" rows="5">@{{v.mo_ta}}</textarea>
                                            </td>
                                            <td class="text-center align-middle">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            ...
                            <input v-model="xoa.ten_hang_xe" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
   ...
   <script>
        new Vue({
            ...
            methods :   {
                themMoi() {
                    axios
                        .post('{{Route('createHang')}}', this.themmoi)
                        .then((res) => {
                            if(res.data.status) {
                ...
                xoaLoai() {
                    axios
                        .post('{{Route('deleteHang')}}', this.xoa)
                        .then((res) => {
                            if(res.data.status) {
                                this.loadData();
                                toastr.success(res.data.message, 'Success');
                ...
                capnhat() {
                    axios
                        .post('{{Route('updateHang')}}', this.xoa)
                        .then((res) => {
                            if(res.data.status) {
                                this.loadData();
                                toastr.success(res.data.message, 'Success');
