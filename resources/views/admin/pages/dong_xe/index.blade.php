            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-header text-center bg-primary">
                        <h6>THÊM MỚI DÒNG XE</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-2">
                            <label>Tên Dòng Xe</label>
                            <input v-model="themmoi.ten_dong_xe" type="text" class="form-control">
                        </div>
                        <div class="mb-2">
                            <label>Mô tả</label>
                            <input v-model="themmoi.ten_dong_xe" type="text" class="form-control">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center align-middle">Tên Dòng Xe</th>
                                ...
                                <tbody>
                                    <template v-for="(v, k) in list_data">
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">@{{v.ten_dong_xe}}</td>
                                            <td class="text-center align-middle">
                                                <textarea cols="20" rows="5">@{{v.mo_ta}}</textarea>
                                            </td>
                                            <td class="text-center align-middle">
              ...
              <div class="modal" id="updateModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-2">
                            <label>Tên DÒNG</label>
                            <input v-model="xoa.ten_dong_xe" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
   ...
   <script>
        new Vue({
            ...
            methods :   {
                themMoi() {
                    axios
                        .post('{{Route('createDong')}}', this.themmoi)
                        .then((res) => {
                            if(res.data.status) {
                ...
                xoaLoai() {
                    axios
                        .post('{{Route('deleteDong')}}', this.xoa)
                        .then((res) => {
                            if(res.data.status) {
                                this.loadData();
                                toastr.success(res.data.message, 'Success');
                ...
                capnhat() {
                    axios
                        .post('{{Route('updateDong')}}', this.xoa)
                        .then((res) => {
                            if(res.data.status) {
                                this.loadData();
                                toastr.success(res.data.message, 'Success');
